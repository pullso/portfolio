 ...
 * limitations under the License.
 */
function Le(e){return Promise.all(e.map((e=>e.catch((e=>e)))))}function Pe(e,t){const n=document.createElement("script");n.src=`${Oe}?l=${e}&id=${t}`,n.async=!0,document.head.appendChild(n)}function De(e){let t=[];return Array.isArray(window[e])?t=window[e]:window[e]=t,t}async function Fe(e,t,n,r,i,s){const o=r[i];try{if(o)await t[o];else{const e=await Le(n),r=e.find((e=>e.measurementId===i));r&&await t[r.appId]}}catch(a){Ne.error(a)}e("config",i,s)}async function Me(e,t,n,r,i){try{let s=[];if(i&&i["send_to"]){let e=i["send_to"];Array.isArray(e)||(e=[e]);const r=await Le(n);for(const n of e){const e=r.find((e=>e.measurementId===n)),i=e&&t[e.appId];if(!i){s=[];break}s.push(i)}}0===s.length&&(s=Object.values(t)),await Promise.all(s),e("event",r,i||{})}catch(s){Ne.error(s)}}function qe(e,t,n,r){async function i(i,s,o){try{"event"===i?await Me(e,t,n,s,o):"config"===i?await Fe(e,t,n,r,s,o):e("set",s)}catch(a){Ne.error(a)}}return i}function Ue(e,t,n,r,i){let s=function(...e){window[r].push(arguments)};return window[i]&&"function"===typeof window[i]&&(s=window[i]),window[i]=qe(s,e,t,n),{gtagCore:s,wrappedGtag:window[i]}}function Ve(){const e=window.document.getElementsByTagName("script");for(const t of Object.values(e))if(t.src&&t.src.includes(Oe))return t;return null}
/**
 * @license
 * Copyright 2019 Google LLC
 *
